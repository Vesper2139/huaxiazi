# Vesper Native Desktop Design System
...
**Product:** Vesper — a compact desktop writing assistant
...
- Preserve the existing dark Vesper visual language; do not introduce a second
