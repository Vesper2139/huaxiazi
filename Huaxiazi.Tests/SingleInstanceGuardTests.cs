...
public sealed class SingleInstanceGuardTests
{
    ...
    {
        var name = SingleInstanceGuard.BuildSessionScopedName("Huaxiazi.Huaxiazi");

        Assert.Equal("Local\\Huaxiazi.Huaxiazi", name);
    ...
    {
        var name = "Huaxiazi.Tests." + Guid.NewGuid().ToString("N");
