...
{
    [Fact]
    public void AssemblyMetadata_UsesHuaxiaziAsTechnicalAndVisibleProductName()
    {
        var assembly = typeof(AppSettings).Assembly;
        Assert.Equal("话匣子", assembly.GetCustomAttributes(typeof(System.Reflection.AssemblyProductAttribute), false)
            .Cast<System.Reflection.AssemblyProductAttribute>().Single().Product);
        Assert.Equal("话匣子", assembly.GetCustomAttributes(typeof(System.Reflection.AssemblyTitleAttribute), false)
    ...
    public void AssemblyMetadata_UsesCurrentReleaseVersion()
    {
        ...
        Assert.Equal(new System.Version(2, 0, 2, 0), version);
    }
