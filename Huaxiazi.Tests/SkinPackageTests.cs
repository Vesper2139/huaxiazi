...
{
    private readonly string _root = Path.Combine(Path.GetTempPath(), "HuaxiaziSkinTests_" + Guid.NewGuid().ToString("N"));

    [Fact]
    public void Install_ValidDataOnlyPackage_IsInstalledAtomically()
    {
        Directory.CreateDirectory(_root);
        var package = CreatePackage("valid.huaxiaziskin", new Dictionary<string, string>
        {
            ["skin.json"] = """
    ...
    {
        Directory.CreateDirectory(_root);
        var package = CreatePackage("unsafe.huaxiaziskin", new Dictionary<string, string>
        {
            ["skin.json"] = """
    ...
    {
        Directory.CreateDirectory(_root);
        var package = CreatePackage("missing-state.huaxiaziskin", new Dictionary<string, string>
        {
            ["skin.json"] = """
    ...
    {
        Directory.CreateDirectory(_root);
        var package = CreatePackage("missing-vector-animation.huaxiaziskin", new Dictionary<string, string>
        {
            ["skin.json"] = """
    ...
    {
        Directory.CreateDirectory(_root);
        var package = CreatePackage("incomplete-theme.huaxiaziskin", new Dictionary<string, string>
        {
            ["skin.json"] = """
