...
{
    private readonly string _root = Path.Combine(Path.GetTempPath(), "VesperAgentSkills_" + Guid.NewGuid().ToString("N"));

    [Fact]
    public void Inspect_StandardPromptSkill_IsReadyAndMapsVesperMode()
    {
    ...
    [Fact]
    public void Inspect_StandardSkillWithoutVesperMetadata_NeedsUserMapping()
    {
