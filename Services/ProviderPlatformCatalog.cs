...
public static class ProviderPlatformCatalog
{
    ...
    [
        ...
        new(ProviderPlatform.MiMo, "MiMo（小米）", "https://api.xiaomimimo.com/v1", "mimo-v2.5-pro", ProviderProtocol.OpenAICompatible, ProviderType.Cloud, false,
            "https://mimo.mi.com", "https://platform.xiaomimimo.com", "使用 Xiaomi MiMo OpenAI 兼容接口；请从官方控制台创建 API Key。",
            [new("MiMo V2.5 Pro", "mimo-v2.5-pro"), new("MiMo V2.5", "mimo-v2.5")], Tier: ProviderPresetTier.More),
